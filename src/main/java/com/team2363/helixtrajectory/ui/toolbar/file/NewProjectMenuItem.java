...
/**
 * This class represents the "New Project" menu item in the file menu.
 * 
...
public class NewProjectMenuItem extends MenuItem {
    ...
    /**
     * Constructs a <code>NewProjectMenuItem</code> and sets its text, graphic, and action.
     */
    public NewProjectMenuItem() {
        setText("New Project...");
        setAccelerator(KeyCombination.keyCombination("shortcut+N"));
        
        graphic = new Image("/icons/file/newproject.png");
