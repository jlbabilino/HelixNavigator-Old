...
public class JSONParser {
     ...
     * for numbers
     */
    // public static Pattern jsonNumberRegex = Pattern.compile("(0|[1-9])\\d*(\\.\\d*)?([eE]\\d+)?"); // old "(0|[1-9]*)(\\.\\d*)?([eE]\\d+)?"
    /**
     ...
     * number. This includes digits (0, 1, 2, ... , 8, 9), minus '-', and the
     * exponent characters 'e' and 'E'.
     *
    ...
    private boolean isCharNumber(char ch) {
        return Character.isDigit(ch) || ch == '-' || ch == 'e' || ch == 'E'; // technically this allows other languages
                                                                             // but doesn't matter because it will be
                                                                             // caught by numberEntry() anyways
    }
