...
public class JSONFormat {
    ...
    /**
     * Constructs a <code>JSONFormat</code> with an array of format options.
     * Default options are selected if they are not given in the options array.
     * Null inputs will not affect the format, and duplicate inputs will result
     * in the input with the greatest index taking affect.
     *
