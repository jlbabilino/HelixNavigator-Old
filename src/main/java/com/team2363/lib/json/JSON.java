...
public class JSON {
    ...
    /**
     * The root <code>JSONEntry</code> of the JSON, or the first JSON structure
     * in it
     */
    private final JSONEntry rootEntry;

    /**
     * Formatting data used during JSON exporting
     */
    ...
    /**
     * Exports this JSON as a String. This can be saved to a <code>.json</code>
     * file to be used with other programs and interfaces.
     *
     * @param options formatting options for JSON exporting
     * @return String exported JSON
     */
    public String exportJSON(JSONFormatOption... options) {
        format = new JSONFormat(options);
